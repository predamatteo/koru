...
class _AppPersonalizationScreenState
  ...
  Future<void> _editName(String pkg, String originalLabel, String? currentCustom) async {
      ...
      body: appsAsync.when(
        ...
        data: (apps) {
          ...
          final sorted = [...filtered]..sort((a, b) {
              final aMod = personalization.isHidden(a.packageName) ||
                  personalization.customName(a.packageName) != null;
              final bMod = personalization.isHidden(b.packageName) ||
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, i) {
              ...
              return ListTile(
                ...
                onLongPress: () => _editName(app.packageName, app.label, custom),
              );
            },
          );
        },
